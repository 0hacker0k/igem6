...
lan_story0=
{
    ...
    "vo_6":"PACO! PACO!",
    "pa_7":"Who are you...",
    "vo_8":"Ah! I'm sorry, I haven't introduced myself yet! I'm a fairy from a faraway island. My full name is Escherichia coli, you can call me E. fairy, I'm on the order of your parents to deliver to you to save the kingdom duty.",
    "pa_9":"The kingdom? I don't understand, now that my grandfather is dying, there is no time to pay attention to you to save the kingdom. Also, how do you know my parents? My parents disappeared ten years ago.",
    "vo_10":"Let me tell you the story, let's start with the crisis of the kingdom. Your grandfather and the kingdom are facing the same problems today. Because of the long-term unhealthy eating habits of the kingdom's people, cardiovascular disease, also known as CVD, is becoming more serious.",
    "pa_11":"Cardiovascular disease? CVD?",
    "vo_12":"Cardiovascular disease, that is, diseases related to the heart and blood vessels. The common cause is the blockage of blood vessels caused by atherosclerosis, which leads to poor blood flow and causes various diseases, such as palpitations, dyspnea, and dizziness…",
    "pa_13":"I remember, these seem to be in the books my parents left.",
    "vo_14":"As expected of you, that is to say, the diseases that endangered your grandfather and the country are mainly due to unhealthy eating habits, and the current disaster will only be faced due to the high cholesterol, high fat, high salt, and high sugar diet.",
    "vo_15":"Anyway, I need your help synthesizing the antidote for CVD and saving the kingdom together.",
    "pa_16":"And one last question, why do you know my parents?",
    "vo_17":"You still care about this matter... They started to study CVD as early as ten years ago, and after obtaining the qualification for the stage, they went to the island to find the antidote, but they still lost the stage and could not bring the antidote with them back to the kingdom. Before they died, they entrusted everything to me and asked me to entrust the task to you. Now, it's up to you what your reply is.",
    "pa_18":"There is no righteous way to save the people in my heart, I just want to save my grandfather, but I will do my best to complete my mission, and I will do my best to save every life. Therefore, I am willing to take on this task.",
    "vo_19":"Very good, so girl, obey your mission and save the world!",
    "back_20":"At dawn, PACO found a disc floating on his chest, and the plate glowed a faint light.",
    "pa_21":"Wh-What is this?",
    "vo_22":"Yo! You're awake. What you saw last night was the illusion of me, and the real one will present in this form. Don't look at me like this, I'm like a key on the way to the antidote, and you will need my help to open the road ahead. So, are you ready to go?",
    "pa_23":"The goal is the antidote on the faraway Island. Let's go.",
    "back_24":"After crossing the ocean, PACO and the fairy finally arrived at the island and went to where PACO's parents lived.",
    "pa_25":"Is...is that...!",
    "vo_26":"That's right, this is one of the altars on the island and one of the places where the antidote is.",
    "vo_27":"There are five altars on the island, and each altar has a priest. They all have clues to the antidote, and your parents also got the answer from them.",
    "pa_28":"No time to waste. Let's go!"
}
lan_story1={
...
lan_story6_determination=
{
    ...
    "npc_42":"Of course, I'm on my own, as long as you give up your resistance now and give me the antidote.",
    "pa_43":"But I say “No”, one of my PACO's favorite things to do is say “No” to those who think they're strong.",
    "npc_44":"What?",
    "back_45":"PACO did not feel despair about being at a disadvantage, on the contrary, his heart was full of excitement and ecstasy.",
    "back_46":"Unprecedented emotions flooded into PACO's heart, knowing how much she wanted to save her grandfather, but now she just wanted to focus on the battle and immerse herself in the new goal - to defeat the opponent in front of her. As a challenger, PACO deeply analyzes the overwhelming power gap.",
    "pa_47":"There are three abilities that the opponent can currently use.",
    "pa_48":'First, "Incinerate"',
    "pa_49":"It should be designed to biosynthesize alkanes, using alkanes as fuel, in the form of a gas gun, and the ignition method should be to use the electron transfer chain in the pathway to form an arc to carry out a wide-range fire attack.",
    "pa_50":'Second, "Defense"',
    "pa_51":"Biosynthesizing the polymers, such as plastics, can form a dense defensive layer to absorb attacks as long as stacked.",
    "pa_52":'Third, "Strengthening"',
    "pa_53":"It can express special proteins enhancing basic physical abilities, such as speed, strength, etc. If not unexpected, it may also have the ability to heal itself.",
    "pa_54":"The condition for the ability to activate is the plasmid behind it. At the moment of each gene and vector ligate, it can be regarded as a transformation into the interior of the E. fairy, and then the fairy expresses the gene.",
    "pa_55":"That is to say…",
    "back_56":'PACO widened the distance and induced the fifth priest to use fire attacks. After several "Incinerate", PACO seized the opportunity, shortened the distance in an instant, and punched a right straight fist at the fifth priest.',
    "back_57":"This attack was blocked by the fifth priest with his left elbow, but it also indirectly confirmed PACO's inference.",
    "pa_58":"Absolutely, he can only express one ability at a time, and he cannot express multiple abilities at the same time.",
    "back_59":"PACO began to predict various attack patterns in her mind, she fully enjoyed the fun, and slowly lost herself in the thrill of battle.",
    "pa_60":"How… delightful!",
    "?_61":"Wake up, PACO!",
    "pa_62":"Don't interrupt me enjoy my time, I'm experiencing the thrill of survival for the first time now, I can fight a powerful enemy, such a surging and climaxing plot is addicting!",
    "?_63":"PACO, have you forgotten what your goal is?",
    "pa_64":"Don't be arrogant, my goal now is to knock down the one in front of me...",
    "back_65":"PACO hesitated, this should not be the answer she was after.",
    "pa_66":"I...",
    "?_67":"Remember your grandfather, your grandfather is sick, you are trying to find an antidote to save him, don't you?",
    "pa_68":"Grandpa...I...",
    "vo_69":"Don't forget your dreams, go through all the hard stages along the way, isn't it just for salvation?",
    "back_70":"PACO widened his eyes and found his original goal.",
    "pa_71":"Thank you, E. fairy."
}
lan_story6_awaken=
{
