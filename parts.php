...
<body onload="load_finish();">
    ...
    <div class="article">
        <div class="in_center">
            ...
            <p>
                &emsp;&emsp;In our project, the <i>pfa A</i> is coepxressed with <i>pfa D</i> under the control of CspA cold-inducible promoter, while the <i>pfa B</i>, <i>pfa C</i>, and <i>pfa E</i> are coexpressed under the control of lac-inducible promoter. The <i>AccD1</i> is co-expressed with <i>AccBC</i> and <i>AccE</i> under the control of lac-inducible promoter.
            </p>
