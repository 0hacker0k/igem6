        ...
        <div class="in_center">
            ...
            <div class="full_block">
                <div class="img" style="--width:80%;">
                    ...
                    <div class="triangle_to_top"></div>Letting participants precisely comprehend the production of our products
                </div>
            </div>
            <div class="full_block">
                <div class="img" style="--width:80%;">
            ...
            <p>
                &emsp;&emsp;According to the data from the Taiwanese government, the elderly percentage near our area is relatively higher than in other places in Taiwan, and through cross-comparison, cardiovascular disease causes great harm here. Hence, based on the research (Oxid Med Cell Longev, Apr 9, 2019, 3756750), we discover that aerobic exercise significantly affects lipid metabolism. Furthermore, we found that "walking" is the easiest way to achieve it in everyone’s daily life because we don’t have to use certain equipment and we can do it without time restrictions. As a result, we initiated a campus walk called ”Walking with the elderly, walking to a better heart.
            </p>
            <h1>Before the activity</h1>
            <p class="h25">
                &emsp;&emsp;Consequently, we cooperated with the “Center for Innovative Research on Aging Society (CIRAS)” in CCU, they provided us some advice and shared some experience on interacting with the elderly, for example, in the interacting game design, we amended some of the word usages that might mislead the public on CIRAS suggestion. In addition, we went to the village and the elderly university in CCU to invite them to our activity in person, hoping our sincere invitation can interest them to participate in the event. In the promotion phase, we know that some of the elderly seldom have an outdoor activity, therefore, this reinforces us to provide a great opportunity for them to walk with us. 
            </p>
            <h1>Record during the activity</h1>
            <p class="h25">
                &emsp;&emsp;On that day, almost a hundred people joined us in the event: “Walking with the elderly, walking to a better heart.” Through this event, we hope to raise public awareness through the interactive game, guiding them to know more about cardiovascular disease. Therefore, we divided the game into 5 stages throughout our walking route.  First, let the public know about the severity of cardiovascular disease. Second, knowing what type of living habit will lead to cardiovascular diseases? Third, how do we prevent cardiovascular disease in every day’s food consumption? Fourth, how do we prevent cardiovascular disease through different kinds of exercise? Last but not least, tested them if they got the ideas for the whole activity.
            </p>
