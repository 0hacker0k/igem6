...
<body onload="load_finish();">
    ...
    <img class="full_size_image" src="<?php echo imgfile;?>/partnership/banner-partnership.png" alt=""> 
    ...
    <div class="article">
        <div class="in_center">
            ...
            <p>
                &emsp;&emsp;Throughout the whole year of iGEM competition, we partnered closely with the <a href="https://2022.igem.wiki/ncku-tainan/partnership" class="link_subtitle">NCKU_Tainan</a> team. The two schools are physically close, and both part of the Taiwan Comprehensive University System (TCUS), a group of four universities in southern Taiwan that have signed an agreement to share many programs and resources. Both teams have maintained active communication and discussion about how to improve our projects. Moreover, we also focused on starting a business, and future collaboration. 
            </p>
            ...
            <p>
                &emsp;&emsp;This was important and meaningful because it was our first opportunity to present our project to others and obtain their feedback, including blind spots we had not noticed, and get useful advice to help us move further. 
            </p>
            ...
            <div class="full_block">
                <div class="img" style="--width:80%;">
                    <img src="<?php echo imgfile;?>/partnership/partnership01.jpg"/>
                    <div class="triangle_to_top"></div>Group photo of CCU_Taiwan and NCKU_Tainan           
                </div>
            </div>
            ...
            <p>
                &emsp;&emsp;However, neither we nor NCKU_Tainan could find a suitable symposium or competition. Thus, our principal investigator, Prof. Yu, suggested that we could hold our own symposium or competition, since the student affairs office was calling for proposals for inter-university activity in TCUS. We submitted a proposal to run a two-day entrepreneurship competition, and the career center, which is under the student affairs office, showed strong interest in our proposal. 
            </p>
            <p>
                &emsp;&emsp;After extensive discussion, we obtained permission and resources to hold the first TCUS Entrepreneurship Competition. For this event, we hosted the competition at our university, and were responsible for logistical support, while NCKU_Tainan was responsible for inviting speakers and companies. 
            </p>
            <p>
                &emsp;&emsp;Through the cooperation, both we and NCKU_Tainan gained feedback about how to start our business. Through this competition, we also connected with the prestigious Taiwan Synbio company, TWBIO, and earned our first MOU with them for cooperation in the future. 
            </p>
            <div class="marge" style="--width:calc(3em + 5vh)"></div>      
            <div class="full_block">
                <div class="img" style="--width:80%;">
                    <img src="<?php echo imgfile;?>/partnership/partnership02.jpg"/>
                    <div class="triangle_to_top"></div>Group photo after the TCUS Entrepreneurship Competition           
                </div>
            </div>
            ...
            <div class="full_block">
                <div class="img" style="--width:80%;">
                    <img src="<?php echo imgfile;?>/partnership/partnership03.jpg"/>
                    <div class="triangle_to_top"></div>Group photo of CCU_Taiwan and NCKU_Tainan after the talk show           
                </div>
            </div>
            <div class="marge" style="--width:calc(3em + 5vh)"></div>      
            <div class="full_block">
                <div class="img" style="--width:80%;">
                    <img src="<?php echo imgfile;?>/partnership/partnership04.jpg"/>
                    <div class="triangle_to_top"></div>Picture of the talk show           
                </div>
            </div>
