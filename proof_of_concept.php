    ...
    <div class="guide" id="guide">
        <div id="guide_content">
            ...
            <div class="guide_sub_label" onclick="move_to_item('7')">
                Cloning <i>AccD1E</i> into pET28a vector
            </div>
    ...
    <div class="article">
        <div class="in_center">
            ...
            <ul>
                ...
                <li>
                    <p>
                        The amplicons of <i>pfa</i> genes were cloned into TA vector for sequencing confirmation. The sequencing results of TA-<i>pfa D</i> and TA-<i>pfa E</i> are shown.
                    </p>
                    <div class="full_block">
                ...
                <li>
                    <p>
                        The amplicons of <i>Acc</i> biobricks were cloned into TA vector for sequencing confirmation. The sequencing results of TA-<i>AccBC</i> and TA-<i>AccD1E</i> are shown.
                    </p>
                    <div class="full_block">
                        <div class="img" style="--width:80%;">
            ...
            <p>
                &emsp;&emsp;The selection results showed an apposite number of colonies at 10 μg/ml of chloramphenicol. Therefore, we selected the Amp (50 μg/ml) and Cm (10 μg/ml) for the double antibiotics selection.
            </p>
            <div class="marge" style="--width:calc(3em + 5vh)"></div>
            ...
            <p>
                &emsp;&emsp;Based on the result of double selection, we started the triple antibiotics selection by fixing the concentrations of Amp (50 μg/ml) and Cm (10 μg/ml). However, these conditions were too harsh when adding kanamycin as the third antibiotic, and only a few colonies survived. We then decreased the concentration of chloramphenicol to 5 μg/ml, and performed triple antibiotics selection with 1.25 μg/ml, 2.5 μg/ml and 5 μg/ml kanamycin.
            </p> 
            <p>
                &emsp;&emsp;The result showed an apposite number of colonies at 5 μg/ml of kanamycin. Therefore, we selected Amp (50 μg/ml), Cm (5 μg/ml) and Kan (5 μg/ml) for the triple antibiotics selection.
            </p>  
            <div class="marge" style="--width:calc(3em + 5vh)"></div>
            <table class="gene_table">
                <thead>
