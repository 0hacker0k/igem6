...
function preload_story6_final (){
    ...
    {//直接調參數
        ...
        "npc_key":'npc5',
        "next_page":ending,
        "lan":lan_story6_final,
        "slide":slide_story6_final,
        'descript_count':1,
        'descript_limit':Object.keys(lan_story6_final).length
    };
    debug=0;
...
function create_story6_final (){
    ...
    grandpa=new createTextBox(this, TextBox_x, TextBox_y, TalkBox_config, 'grandpa');
...
function update_story6_final (){//與外界有關的互動
