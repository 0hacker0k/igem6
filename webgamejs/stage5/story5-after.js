...
function preload_story5_after (){
    con=
    {//直接調參數
        "img_num_start":39,
        "img_num_end":41,
        "npc_key":'npc5',
        "next_page":stage_6_story_determination,
        "lan":lan_story5_after,
        "slide":slide_story5_after,
        'descript_count':1,
        'descript_limit':Object.keys(lan_story5_after).length
    };
    debug=0;
...
function update_story5_after (){//與外界有關的互動
