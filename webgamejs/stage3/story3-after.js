...
function preload_story3_after (){
    ...
    {//直接調參數
        ...
        "npc_key":'npc3',
        "next_page":map_1,
        "lan":lan_story3_after,
        "slide":slide_story3_after,
        'descript_count':1,
        'descript_limit':Object.keys(lan_story3_after).length
    };
    debug=0;
...
function update_story3_after (){//與外界有關的互動
