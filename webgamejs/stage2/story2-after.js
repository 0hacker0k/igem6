...
function preload_story2_after (){
    ...
    {//直接調參數
        ...
        "npc_key":'npc2',
        "next_page":map_1,
        "lan":lan_story2_after,
        "slide":slide_story2_after,
        'descript_count':1,
        'descript_limit':Object.keys(lan_story2_after).length
    };
    debug=0;
...
function update_story2_after (){//與外界有關的互動
