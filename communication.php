...
<body onload="load_finish();">
    ...
    <div class="article">
        <div class="in_center">
            ...
            <p>
                &emsp;&emsp;To alleviate public prejudice against synthetic biology without being limited by distance, we utilized <b>social media</b>, <b>web games</b> and <b>pop-up activity</b>. In social media, we regularly posted knowledge about synthetic biology to enable all ages to learn about biotechnology. In the web game, we focused on introducing the experimental process, and conveyed the benefits of synthetic biology. We also held a local activity on World Heart Day, reminding the public of the importance of CVD prevention, and explaining how we deal with this problem using synthetic biology. 
            </p>
            <p>
                &emsp;&emsp;To share the power of synthetic biology, we held an <b>Open Lab</b> activity, and introduced the beauty of synthetic biology by allowing the teenagers to personally operate the experiment. We also held a <b>campus walking activity</b> to tell the nearby elderly how our PACOmega project contributes to CVD prevention. Finally, we held the <b>Taiwan Comprehensive University System (TCUS) entrepreneurship competition</b>, in which we and other iGEM teams shared our projects with synthetic biology professors and a company. Consequently, we build connections to translate our ideas into real products in the future.  
            </p>
            ...
            <h1>All ages, not limited by distance</h1>
            <p>
            ...
            <h1>Synthetic biology followers</h1>
            <p>
            ...
            <p>
                &emsp;&emsp;During this conference, we received feedback on our presentation and poster, and we got some inspiration about how we can present our project to the public and synthetic biology followers more clearly. Also, we were inspired to further develop our Quantitative Agar Faucet. Therefore, to improve our equipment to accomplish automation and standardization, we interviewed Prof. Lee.
            </p>
            <p>
                &emsp;&emsp;After the Meet, further collaboration led to projects such as the iGEM theme song project with CSMU_Taiwan, iGEM map with NTHU_Taiwan, and the infographic exchange with Gems_Taiwan. 
            </p>
            <div class="full_block">
                <div class="img" style="--width:60%;">
