<header class="navbar navbar-expand-lg navbar-light main-bg-color" style="z-index:10000;" id="navbar">
    ...
    <div class="nav">
        ...
        <div class="dropdown">
            <button onmouseout="hide_bar('myDropdown6')" onmouseover="show_bar('myDropdown6')" class="dropbtn"><img class="drop" src="<?php echo imgfile;?>/drop.png" alt=""><a href="notebook.php" style="text-decoration:none;color:FFCAE7">Notebook</button>
